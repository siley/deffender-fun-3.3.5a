...
bool Guild::HasLevelForBonus(uint8 guildBonus)
{
    ...
    case GUILD_BONUS_REPERATUR_3:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_REPERATUR_3);
        break;
    ...
    case GUILD_BONUS_MAIL_1:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_MAIL_1);
        break;
    case GUILD_BONUS_MAIL_2:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_MAIL_2);
        break;
    case GUILD_BONUS_DURATION:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_DURATION);
        break;
    case GUILD_BONUS_VAULT:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_VAULT);
        break;
    case GUILD_BONUS_MOUNT_GRFLY:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_MOUNT_GRFLY);
        break;
    case GUILD_BONUS_MOUNT_GROUND_FLY:
        return m_guild_level >= sWorld->GetReqGuildLevelForBonus(GUILD_BONUS_MOUNT_GROUND_FLY);
        break;
    default:
        return false;
        break;
