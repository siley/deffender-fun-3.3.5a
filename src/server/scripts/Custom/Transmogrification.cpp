...
bool Transmogrification::CanTransmogrifyItemWithItem(Player* player, ItemTemplate const* proto2, ItemTemplate const* proto1)
{
    ...
    if (proto1->SubClass != proto2->SubClass &&
        (proto1->Class != ITEM_CLASS_WEAPON || !GetAllowMixedWeaponTypes() || (!IsRangedWeapon(proto2->SubClass, proto2->Class) || !IsRangedWeapon(proto1->SubClass, proto1->Class))) &&
        (proto1->Class != ITEM_CLASS_ARMOR || !GetAllowMixedArmorTypes() || proto1->SubClass < ITEM_SUBCLASS_ARMOR_CLOTH || proto1->SubClass > ITEM_SUBCLASS_ARMOR_PLATE || proto2->SubClass < ITEM_SUBCLASS_ARMOR_CLOTH || proto2->SubClass > ITEM_SUBCLASS_ARMOR_PLATE))
        return false;
...
void Transmogrification::LoadConfig(bool reload)
{
    ...
    {
        TC_LOG_ERROR("loading", "Transmogrification.TokenEntry (%u) does not exist. Using default.", TokenEntry);
        TokenEntry = 49426;
    }
}