...
public:
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 sender, uint32 action)
    {
        ...
        else
        {
            ...
            sBattlegroundMgr->BuildBattlegroundStatusPacket(&data, arenaChosen, queueSlot, STATUS_IN_PROGRESS, arenaChosen->GetEndTime(), arenaChosen->GetStartTime(), arenaChosen->GetArenaType(), player->GetTeam());
