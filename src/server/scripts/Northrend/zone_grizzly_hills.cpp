...
//pop de gob 194238
uint8 NPC_TEXTID_MAIDEN_OF_DRAK_MAR_01 = 1850000;
uint8 NPC_TEXTID_MAIDEN_OF_DRAK_MAR_02 = 1850001;
uint8 NPC_TEXTID_MAIDEN_OF_DRAK_MAR_03 = 1850002;
uint8 NPC_TEXTID_MAIDEN_OF_DRAK_MAR_04 = 1850003;
uint8 MAIDEN_OF_DRAK_MAR_TIMER_00 = 2000;
uint8 MAIDEN_OF_DRAK_MAR_TIMER_01 = 5000;
uint8 MAIDEN_OF_DRAK_MAR_TIMER_02 = 6000;
uint8 MAIDEN_OF_DRAK_MAR_TIMER_03 = 7000;
uint8 MAIDEN_OF_DRAK_MAR_TIMER_04 = 20000;
uint8 MAIDEN_OF_DRAK_MAR_GOB_01 = 194239;
uint8 MAIDEN_OF_DRAK_MAR_GOB_02 = 194238;
    ...
    struct npc_maiden_of_drak_marAI : public ScriptedAI
    {
        ...
        void UpdateAI(uint32 diff) override
        {
            if(uiPhaseTimer <= diff)
            {
                ...
                {
                    case 1:
                        Talk(NPC_TEXTID_MAIDEN_OF_DRAK_MAR_01, me);
                        uiPhaseTimer = MAIDEN_OF_DRAK_MAR_TIMER_01;
                        break;
                    case 2:
                        Talk(NPC_TEXTID_MAIDEN_OF_DRAK_MAR_02, me);
                        uiPhaseTimer = MAIDEN_OF_DRAK_MAR_TIMER_02;
                        break;
                    case 3:
                        Talk(NPC_TEXTID_MAIDEN_OF_DRAK_MAR_03, me);
                        uiPhaseTimer = MAIDEN_OF_DRAK_MAR_TIMER_03;
                        break;
                    case 4:
                        Talk(NPC_TEXTID_MAIDEN_OF_DRAK_MAR_04, me);
