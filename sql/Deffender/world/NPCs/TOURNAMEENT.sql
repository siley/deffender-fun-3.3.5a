...
UPDATE `creature_template` SET `npcflag`=`npcflag`|16777216,`faction`=35,`unit_flags`=0,`speed_run`=1.5714285714286,`vehicleid`=349 WHERE `entry`=33318; -- Exodar Elekk
...
UPDATE `creature_template` SET `npcflag`=`npcflag`|16777216,`faction`=35,`unit_flags`=0,`speed_run`=1.5714285714286,`vehicleid`=349 WHERE `entry`=33317; -- Gnomeregan Mechanostrider
UPDATE `creature_template` SET `npcflag`=`npcflag`|16777216,`faction`=35,`unit_flags`=0,`speed_run`=1.5714285714286,`vehicleid`=349 WHERE `entry`=33319; -- Darnassian Nightsaber
...
UPDATE `creature_template` SET `npcflag`=`npcflag`|16777216,`faction`=35,`unit_flags`=0,`speed_run`=1.5714285714286,`vehicleid`=349 WHERE `entry`=33845; -- Quel'dorei Steed
